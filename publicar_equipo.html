...
<div class="container">
    ...
    <h2>PUBLICAR EQUIPO</h2>
    <label>Nombre Largo:</label>
    <input type="text" class="input-field" placeholder="Nombre largo">
    <label>Nombre Corto:</label>
    <input type="text" class="input-field" placeholder="Nombre Corto">
    
    <h3>Integrantes:</h3>
    <div class="integrante">Mario Juanito Alcachofa</div>
    <div class="integrante">Mario Juanito Alcachofa</div>
    <div class="integrante">Juan Melgarejo R.</div>
    <div class="integrante">Pedro Sanchez Gonzales</div>
    
    <button class="btn btn-primary">PUBLICAR GRUPO</button>
</div>
</body>
</html>
